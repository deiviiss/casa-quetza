...
export const TopMenu = () => {
  ...
  return (
    <div className={`w-full fixed top-0 z-20 text-white ${isProductDetail ? 'bg-slate-800' : bgColor} transition-colors duration-300`}>
      <header className="container mx-auto lg:px-20 px-4 py-1 flex justify-between items-center">
        ...
        <nav>
          <ul className="space-x-4 flex">
            <li><Link href="/" className="hover:text-slate-200 transition-transform">Inicio</Link></li>
            <li><Link href="/memberships" className="hover:text-slate-200 transition-transform">Membresías</Link></li>
            <li><Link href="/products" className="hover:text-slate-200 transition-transform">Dispensario digital</Link></li>
          </ul>
        </nav>
      </header>
    </div>
